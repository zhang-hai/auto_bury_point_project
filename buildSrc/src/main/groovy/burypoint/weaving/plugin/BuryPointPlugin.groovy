package burypoint.weaving.plugin

import com.android.build.api.transform.*
import com.android.build.gradle.AppExtension
import com.android.build.gradle.LibraryExtension
import com.android.build.gradle.internal.pipeline.TransformManager
import com.harry2815.burypoint.common.CommonClassVisitor
 ...
 * function：
 */
public class BuryPointPlugin extends Transform implements Plugin<Project> {

    private boolean isApp = true

    public BuryPointPlugin(){
    }
    ...
    public void apply(Project project) {
        ...
        println '> android  ---------------------------------'+android + ",isApp --- "+ isApp
    }

    @Override
    public String getName() {
        return "BuryPointPlugin"
    }
    ...
    public Set<? super QualifiedContent.Scope> getScopes() {
        return isApp ? TransformManager.SCOPE_FULL_PROJECT : TransformManager.PROJECT_ONLY
    }
...
//                    ClassVisitor cv = new CommonClassVisitor(classWriter)
